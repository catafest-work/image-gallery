...
// define a type like: {images}: {images: Image[]  } for image from supabase and need to update and iterate through these images
export default function Gallery({images}: {images: Image[]  }) {
  //return 'Hello world!'
  return (
    <div className="max-w-2xl mx-auto py-16 px-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
...
// changes to Image type is send to BlurImage like arg : {image}): {image: Image}
  ...
  return (
    <a href={image.href} className="group">
      <div className="w-full aspect-w-1 aspect-h-1 bg-gray-200 rounded-lg overflow-hidden xl:aspect-w-7 xl:aspect-h-8">
        <Image 
        alt=""
        //src="http://bit.ly/placeholder-img" 
        src={image.imageSrc}
        layout="fill"
        objectFit="cover"
  ...
  return (
    <a href="#" className="group">
      <div className="aspect-w-1 aspect-h-1 xl:aspect-w-7 xl:aspect-h-8 w-full overflow-hidden rounded-lg bg-gray-200">
        <img alt="" src="http://bit.ly/placeholder-img" className="group-hover:opacity-75" />
      </div>
      <h3 className="mt-4 text-sm text-gray-700">Lee Robinson</h3>
      <p className="mt-1 text-lg font-medium text-gray-900">@leeerob</p>
    </a>
